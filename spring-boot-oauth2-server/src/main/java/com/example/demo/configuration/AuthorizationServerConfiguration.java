...
//	@Value("${resource.id:oauth2-resource}") // 默认值spring-boot-application
...
//	int accessTokenValiditySeconds = 3600;
	...
	public void configure(AuthorizationServerSecurityConfigurer oauthServer) throws Exception {
		oauthServer.allowFormAuthenticationForClients().passwordEncoder(MD5PasswodEncoder.getInstance());// 允许客户表单认证
