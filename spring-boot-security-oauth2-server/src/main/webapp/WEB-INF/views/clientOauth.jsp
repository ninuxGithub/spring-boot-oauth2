...
<head>
	...
	<title>Client_Details Oauth</title>
		...
		<div class="panel panel-body">
			<form action="${request.contextPath}/oauth/token"  method="post">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="clientId" name="client_id" value="client_auth_mode" placeholder="input ClientId (客户端必须支持授权码方式)....">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="grantType" name="grant_type" value="client_credentials" readonly="readonly">
					</div>
				</div>
				<div class="form-group">
